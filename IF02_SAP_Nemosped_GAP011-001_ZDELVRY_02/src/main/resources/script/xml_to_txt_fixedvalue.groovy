...
def Message processData(Message message) {
	...
	def len_E1EDL20     = "10;";
	def len_E1ADRM1     = "3;17;40;40;40;10;40;3;30;70;";
	def len_E1EDT13     = "3;8;";
	def len_E1EDL24     = "6;18;13;3;10;4;4;8;";
    ...
    def CRETIM = dateFormat.format(date).substring(9);
 	...
 	xmlIn.children().each{ rows ->
		rows.children().each{ row ->
    				    ...
    				    case "E1ADRM1": 
    				         E1EDL20.children().each{ E1ADRM1 ->
    				            switch("${E1ADRM1.name()}"){
                				    ...
                				    case "TELEPHONE1": 
            						     if("${E1ADRM1.text()}" != ""){
                				            TELEPHONE1 = "${E1ADRM1.text()}".replaceFirst ("^0*", "");
            						     }
                				         break;
            						case "E_MAIL": 
            						     if("${E1ADRM1.text()}" != ""){
                				            E_MAIL = "${E1ADRM1.text()}".replaceFirst ("^0*", "");
            						     }
                				         break;	
    				            } 
        				        } 
            				        E1ADRM1_tmp = E1ADRM1_tmp + PARTNER_Q + sep + PARTNER_ID + sep + NAME1 + sep + NAME2 + sep + STREET1 + sep + POSTL_COD1 + sep + CITY1 + sep + COUNTRY1 + sep + TELEPHONE1 + sep + E_MAIL + sep;
    				        ...
    				        case "E1EDL24": 
    				        if (Double.parseDouble(E1EDL20.LFIMG.text()) == 0)
    				            break;
    				         ...
    				         E1EDL20.children().each{ E1EDL24 ->
    				            switch("${E1EDL24.name()}"){
            				        ...
            				        E1EDL24_tmp = E1ADRM1_tmp + POSNR + sep + MATNR + sep + LFIMG + sep + VRKME + sep + CHARG + sep + WERKS + sep + LGORT + sep + VFDAT + sep;
		    ...
		    E1EDL20_tmp = E1EDL20_tmp + VBELN + sep;
	        E1EDL20_child = E1EDL20_child + "E1EDL20" + FixedValue(E1EDL20_tmp,len_E1EDL20) + "\n";
	        E1EDL20_tmp = "";
	        
	        txt = txt + E1EDL20_child + E1ADRM1_child + E1EDT13_child + E1EDL24_child;
	        E1EDL20_child = "";
	        E1ADRM1_child = "";
	        E1EDT13_child = "";
	        E1EDL24_child = "";
